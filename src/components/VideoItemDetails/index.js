...
class VideoItemDetails extends Component {
  ...
  renderSuccessView = (isDark, onSavingVideo, onUnSavingVideo) => {
    const {videoDetailObject, isSaved} = this.state
    const {
      id,
      title,
      videoUrl,
      ...
      <div className="main-container">
        ...
        <div>
          ...
          <div className="like-or-dislike-container">
            <button type="button" onClick={this.onClickedLike}>
              Like
            </button>
            <button type="button" onClick={this.onClickedDislike}>
              Dislike
            </button>
            <button
              type="button"
